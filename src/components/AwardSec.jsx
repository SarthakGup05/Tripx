      ...
      >
        ...
        <div className="container">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-md-6 col-lg-5 col-xxl-5">
              <div className="google-reviewed mx-auto overflow-hidden">
                <div className="left bg-white-color d-flex align-items-center gap-2">
                  <img src="assets/img/icons/awards-google.png" alt="google" />
                  <div className="info">
                    <strong className="d-block">Google</strong>
                    <span className="d-block fs-xxs text-uppercase">
                      Reviewed by
                    </span>
                  </div>
                </div>
                <div className="right bg-second-theme-color">
                  <div className="rating d-flex align-items-baseline gap-2">
                    <h4 className="fs-32 fw-semibold ff-rubik text-white-color">
                      4.5
                    </h4>
                    <div className="stars">
                      <ul className="custom-ul d-flex align-items-center text-theme-color fs-xxs">
                        <li>
                  ...
                  <span className="review fs-xxs d-block">8.5k reviews</span>
                </div>
              </div>
            </div>
          </div>
          <div className="row g-2 g-lg-4 award-box-style1__row">
            <div className="line-Shape" />
            <div
              className="col-md-6 col-lg-4 fade-anim"
              data-delay="0.30"
              data-direction="right"
            >
              <div className="award-box-style1">
                <div className="award-box-style1-wrapper">
                  <figure className="award-box-icon">
                    <svg
                  ...
                  <div className="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                    <img
                      src="assets/img/awards/award-box-left-wings.png"
                      alt="award-box-left-wings"
                    />
                    <h6 className="text-capitalize ff-rubik fw-semibold">
                  ...
                  <div className="award-box-body text-center">
                    <span className="text-third-theme-color bg-white-color">
                      world travel
                    </span>
                  </div>
                  <div className="award-box-footer text-capitalize text-center">
                    <p className="line1">
            ...
            >
              <div className="award-box-style1">
                <div className="award-box-style1-wrapper">
                  <figure className="award-box-icon text-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={132}
                      height={103}
